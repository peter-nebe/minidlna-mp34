...
#ifndef FFMPEG_CMDUTILS_HOOK_H_
#define FFMPEG_CMDUTILS_HOOK_H_

#define exit_program exit_program_hooked
#define exit exit_hooked

void exit_hooked(int ret);

#endif /* FFMPEG_CMDUTILS_HOOK_H_ */
